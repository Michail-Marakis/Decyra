...
import com.example.decyra.backend.ai.callbacks.PineconeCallback;
...
public class PineconeClient {
    ...
    /**
     * Instantiates a new Pinecone client.
     */
            ...
            httpClient.newCall(request).enqueue(new Callback() {
                ...
                public void onResponse(@NonNull Call call, @NonNull Response response) {
                    try {
                        ...
                        // ΕΔΩ ΣΤΕΛΝΟΥΜΕ ΤΟΝ ΠΙΝΑΚΑ ΓΙΑ ΤΟ COHERE
                        callback.onSuccess(matchesArray);
